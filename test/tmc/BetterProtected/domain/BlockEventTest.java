...
public class BlockEventTest {
    ...
    public void canSerializeAndDeserialize() {
        ...
        BlockEvent blockEvent = new BlockEvent(placedOn, new Player("Jason"), BlockEventType.PLACED, new BlockCoordinate(1L, 2L, 3L), new ChunkCoordinate(1L, 2L), new World("narnia"), Material.DIRT);
        ...
        assertThat(deserializedBlockEvent.getOwner(), is(new Player("Jason")));
